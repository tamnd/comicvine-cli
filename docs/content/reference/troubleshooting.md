...
Most of these come down to network reality or how comicvine serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

comicvine rate-limits like any public site. comicvine already paces
...
Where a surface is gated, comicvine reads a cookie or token you supply
...
`comicvine`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what comicvine actually did
