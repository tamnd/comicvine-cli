...
```
comicvine <command> [arguments] [flags]
```

Run `comicvine <command> --help` for the full flag list on any command. This
...
per operation you declare in `comicvine/domain.go`.
